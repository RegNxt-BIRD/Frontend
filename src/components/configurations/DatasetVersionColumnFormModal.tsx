...
const formSchema = z.object({
  // ... (keep the same schema as before)
});

type FormValues = z.infer<typeof formSchema>;

interface DatasetVersionColumnFormModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (column: Partial<FormValues>) => void;
  initialData?: Partial<FormValues>;
}

export const DatasetVersionColumnFormModal: React.FC<
  DatasetVersionColumnFormModalProps
        ...
        <Form {...form}>
          ...
          >
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="S">Secondary</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <FormField
                control={form.control}
                name="datatype_format"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Data Type Format</FormLabel>
                    <FormControl>
                      <Input {...field} />
                    </FormControl>
                    <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Value Statement</FormLabel>
                  <FormControl>
                    <Textarea {...field} />
                  </FormControl>
                  <FormMessage />
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between space-x-2">
                    <FormLabel className="text-base">Is Filter</FormLabel>
                    <FormControl>
                      <Switch
                        checked={field.value}
                        onCheckedChange={field.onChange}
              ...
              <FormField
                control={form.control}
                name="is_report_snapshot_field"
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between space-x-2">
                    <FormLabel className="text-base">
                      Report Snapshot Field
                    </FormLabel>
                    <FormControl>
                      <Switch
                        checked={field.value}
